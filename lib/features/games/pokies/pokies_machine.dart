...
class PokiesMachineController {
  const PokiesMachineController({
    required this.start,
    required this.stop,
  });
...
class PokiesMachine extends StatefulWidget {
  ...
  final Function(PokiesMachineController) onCreated;
...
class _PokiesMachineState extends State<PokiesMachine> {
  late PokiesMachineController _slotMachineController;
  ...
  void initState() {
    ...
    _slotMachineController = PokiesMachineController(
      start: _start,
      stop: _stop,
    );
